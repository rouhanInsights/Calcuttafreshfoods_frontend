        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="max-w-lg">
            ...
            <p className="text-gray-600 mb-6">
              Order fresh meat and seafood on the go with our easy-to-use mobile app. 
              Get exclusive app-only offers and track your delivery in real-time!
            </p>
          ...
          <div className="bg-white p-4 rounded-xl shadow-lg">
            <div className="bg-gray-200 rounded-lg h-80 w-60 flex items-center justify-center">
              <p className="text-gray-500 text-center px-4">Mobile App Screenshot</p>
            </div>
          </div>
