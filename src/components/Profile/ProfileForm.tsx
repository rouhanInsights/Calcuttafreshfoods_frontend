  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-6 space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <Input name="alt_phone" value={form.alt_phone} onChange={handleChange} placeholder="Alternate Phone (Optional)" />
        <Input name="email" value={form.email} onChange={handleChange} placeholder="Email" required />
        <Input name="alt_email" value={form.alt_email} onChange={handleChange} placeholder="Alternate Email (Optional)" />
        ...
        <Input name="profile_image_url" value={form.profile_image_url} onChange={handleChange} placeholder="Profile Image URL" />
      </div>
